...
let weather = {
    ...
    displayWeather: function (data)  {
        ...
        document.querySelector(".description").innerText = "Cảm nhận như" + " " + feels_like + "°C," + " " + description;
        ...
        document.querySelector(".visibility").innerText ="Tầm nhìn xa:" + " " + visibility / 1000 + "km";
